...
export default function NavigationCard() {
  ...
  return (
    <Card noPadding={true}>
      <div className="px-4 py-4 flex gap-4 justify-between md:block shadow-md shadow-gray-500 md:shadow-none relative z-50">
        ...
        {user.accessToken ? (
          <>
            {/*<NavLink to={`/profile/${user?._id}/followers`} className={({ isActive }) => isActive ? activeElement : nonActiveElement}>
            ...
            <NavLink to={`/${user?._id}/bookmarks`} className={({ isActive }) => isActive ? activeElement : nonActiveElement}>
            ...
            {/* <NavLink to='/settings' className={({ isActive }) => isActive ? activeElement : nonActiveElement}>
        ...
        {user.accessToken ? (
        <NavLink to='/logout' className={({ isActive }) => isActive ? activeElement : nonActiveElement}>
          ...
          <>
            <NavLink to='/login' className={ nonActiveElement }>
            ...
            <NavLink to='/register' className={ nonActiveElement }>
