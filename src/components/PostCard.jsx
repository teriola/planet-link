    ...
    <>
      ...
      <Card>
        <div className="flex gap-3">
          ...
          <div className="grow">
            <p>
              <Link to={`/profile/${_id}/posts`} className="font-semibold cursor-pointer hover:underline">{post.owner.name} {post.owner.surname}</Link>
        ...
        <div>
          <p className="my-3 text-sm">{post.message}</p>
          ...
          <div className="mt-5 flex gap-8">
            <button className="flex gap-2 items-center" onClick={() => onLikeClick(user._id)}>
