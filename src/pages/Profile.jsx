...
import { followUser, getUserById } from '../services/userService';
...
export default function ProfilePage() {
    ...
    const { theme, themeToggleHandler } = useThemeContext();
                ...
                <div className="relative overflow-hidden rounded-md">
                    ...
                    <div className="p-4 pt-0 md:pt-4 pb-0">
                        <div className='ml-28 md:ml-40'>
                            ...
                            {user._id == currentUser._id ?
                                <>
                                    ...
                                    <span className="absolute right-12 bottom-24 cursor-pointer" onClick={themeToggleHandler}>
                                        {theme === 'light'
                        ...
                        <div className='mt-4 md:mt-10 flex md:gap-0 gap-10 justify-center'>
                            ...
                            <Link to="followers" className={path.includes('followers') ? activeTab : nonActiveTab}>
